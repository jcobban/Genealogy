                        ...
                        feedbackParm) 
{
    ...
    request.onreadystatechange = function() {
        ...
        {               // done
            ...
            if (request.status == 404)  // HTTP not found
 ...
 *  Parameters:                                                         *
 *      url             URL including optional parameters               *
 *      values          array of values to pass by method=POST          *
 *      callback        function to call when page retrieved            *
 *      errorHandler    function to call for error status               *
 *      feedbackParm    parameter to pass to all callbacks              *
 ************************************************************************/
                     ...
                     feedbackParm) 
{
    ...
    request.onreadystatechange = function() {
        ...
        {               // done
            if (request.status == 200)
            {           // OK
                callback(HTTP._getResponse(request), feedbackParm);
            }           // OK
            else
            {           // any other response from server
                if (errorHandler)
 ...
 *                                                                      *
 *  Parameters:                                                         *
 *      request     instance of XmlHttpRequest                          *
 ************************************************************************/
