 ...
 *  History:                                                            *
 *      2020/01/13      created                                         *
 *      2020/04/30      use addEventListener                            *
 *                      hide right column                               *
 *                                                                      *
...
function onLoad()
{
    ...
    {       // loop through all forms
        ...
        {   // loop through all elements of form
            ...
            if (mouseOn.addEventListener)
            {
                mouseOn.addEventListener('mouseover', eltMouseOver, false);
                mouseOn.addEventListener('mouseout', eltMouseOut, false);
            }
            ...
            {       // act on a field from a table row
                ...
                {       // advertiser name
                    ...
                    if (element.addEventListener)
                        element.addEventListener('change', changeName, false);
                    break;
                }       // advertiser name
                ...
                {       // delete this advertiser
                    ...
                    if (element.addEventListener)
                        element.addEventListener('click', deleteAdvertiser, false);
                    break;
                }       // delete this advertiser
                ...
                {
                    if (element.addEventListener)
                        element.addEventListener('click', addAdvertiser, false);
                    break;
                }
            }           // act on a field
...
function addAdvertiser()
{
    ...
    nameElt.focus();
    nameElt.select();
    if (nameElt.addEventListener)
        nameElt.addEventListener('change', changeName, false);
