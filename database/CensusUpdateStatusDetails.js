 ...
 *      2022/07/05      use addEventListener                            *
 *                                                                      *
...
function onLoad()
{
    ...
    {                   // loop through all hyper-links
        ...
        linkTag.addEventListener("mouseover", linkMouseOver);
        linkTag.addEventListener("mouseout", linkMouseOut);
    }                   // loop through all hyper-links
    ...
    {                   // loop through all forms
        ...
        {               // loop through all elements in form
            ...
            {           // act on alphabetic part of name
                case 'edit':
                {
                    element.addEventListener("click", editPage);
                    break;
                }

                case 'upload':
                {
                    element.addEventListener("click", copyPage);
                    break;
                }
            }           // act on alphabetic part of name
        }               // loop through all elements in form
