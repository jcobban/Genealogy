...
import {changeCounty, changeTownship, getCounties, getDefaultLocation} 
            from "../jscripts6/Ontario.js";
import {capitalize, SurnAbbrs, GivnAbbrs, OccAbbrs, MonthAbbrs, RelAbbrs,
        LocAbbrs, change, dateChanged, expAbbr,
        checkName, checkOccupation, checkAddress, checkDate, checkURL} 
            from "../jscripts6/CommonForm.js";
import {locationChanged}
            from "../jscripts6/locationCommon.js";

window.addEventListener("load", onLoadBirths);
