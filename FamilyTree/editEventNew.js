 ...
 *  page editEventNew.php, which implements the ability to edit			*
 ...
 *						editEventNew.php, instead of being extracted by	*
...
function changeEtype()
{
    ...
    //alert("changeEtype: idet=" + idet + ", citType=" + citType + ", url='" + url + "'");
    ...
    //alert("changeEtype: url='" + url + "'");

    // reinvoke editEventNew.php with the parameters to create the dialog
    // for the new event
    location	            = url;
}		// function changeEtype
