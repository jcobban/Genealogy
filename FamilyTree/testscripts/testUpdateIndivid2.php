...
?>
      <tr>
        <input type="text" name="EventIder<?php print $rownum; ?>"
                        id="EventIder<?php print $rownum; ?>"
                        class='white left' size="11"
...
<?php
        ...
        {   // loop through Events
            ...
            $type       = ucfirst(trim(Event::$eventText[$idet]));
            $date       = $event->getDate();
...
?>
        <input type="text" class="rightnc"
                        style="width: 8em;"
                        name="EventOrder<?php print $rownum; ?>"
                        id="EventOrder<?php print $rownum; ?>"
                        value="<?php print $order; ?>">

          <input type='text' name='EventChanged<?php print $ider; ?>'
                class 'white right' size="1"
                value='0'>
        </td>
        <td class='cell left'>
