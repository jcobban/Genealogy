...
$t                      = $translate['tranTab'];
$citText                = $translate['typeText'];   // TemplateTag
...
if (is_string($idtrtext))
    $msg     .= "Invalid value for IDTR='$idtrtext'. ";
    ...
    {       // take action according to type
        ...
        case Citation::STYPE_EVENT: // 30 Individual Event
        {
            ...
            if (!is_null($person))
            {
                ...
                if (strlen($surname) == 0)
                    $surname        = $person->getSurname();
                if (array_key_exists($idet, $idetTitleText))
...
// not completely converted to template
    htmlHeader($heading,
    ...
    -->
          <tr id="sourceRow$rownum" >
            ...
            <input type="text" name="Page$rownum" id="Page$rownum"
                    class="white leftnc" value="$detail" 
                    size="37" style="width: 18em;">
