...
?>
    ...
    <div class="balloon" id="HelpEdit">
      Clicking on this button pops up a dialog to edit the set of parents
      summarized on this row of the dialogue.
    </div>
    <div class="balloon" id="HelpDelete">
      Delete the set of parents described by this row.
    </div>
    <div class="balloon" id="HelpAdd">
      Clicking on this button pops up a dialog to add a new set of parents to
      this child.
    </div>
    <div class="balloon" id="HelpFinish">
      Clicking on this button closes the dialog.  The changes to the database
    ...
    <div class="balloon" id="HelpeditHusb">
      Click on this button to open a dialog to edit the detailed information
      about the father in this set of parents.
    </div>
    <div class="balloon" id="HelpWifeGivenName">
      This displays the given names of the mother.
      If you alter this field it changes the given name of the individual.
    </div>
    <div class="balloon" id="HelpWifeSurname">
      This displays the family name of the mother.
      If you alter this field it changes the family name of the individual.
    </div>
    <div class="balloon" id="HelpWifeMarrSurname">
      This displays the family name by which the mother was known during this
    ...
    <div class="balloon" id="HelpdetachHusb">
      Selecting this button detaches the currently assigned father from this
    ...
    <div class="balloon" id="HelpdetachWife">
      Selecting this button detaches the currently assigned mother from this
      marriage.  It is not necessary to do this before selecting or creating
      a new mother.
    </div>
    <div class="balloon" id="HelpMarD">
      Supply the date of the marriage.  The program understands a wide
      ...
      See <a href="datesHelpen.html">supported date formats</a> for details.
    </div>
    ...
    <div class="balloon" id="HelpmarriageDetails">
      Clicking on this button opens a dialog that permits you to add further
      details about the marriage and to specify source citations for the fact.
    </div>
    <div class="balloon" id="HelpMarEndD">
      Supply the date that the marriage or relationship came to an end.
      ...
      The program understands a wide
      variety of date formats which are too extensive to be described here.
      It is suggested that you enter the date of marriage in the form "dd mmm yyyy"
      where "dd" is the day of the month, "mmm" is a 3 letter abbreviation for the
      name of the month, and "yyyy" is the year of the marriage.
    ...
    <div class="balloon" id="HelpSealD">
      Supply the date that the partners were sealed to each other at a
    ...
    <div class="balloon" id="HelpOrderEvents">
      Selecting this button reorders the events of this marriage by their dates.
    </div>
    ...
    <div class="balloon" id="HelpMarriedNameRule">
      This selection list permits you to specify whether or not the mother
    ...
    <div class="balloon" id="HelpnoChildren">
      Select this checkbox if you know that this family had no children.
    </div>
    <div class="balloon" id="HelpnoChildDetails">
      Click on this button to add additional information about the fact that this
