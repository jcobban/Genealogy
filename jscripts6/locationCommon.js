...
import {capitalize, expAbbr, focusNext} 
 ...
 ************************************************************************/
var housePattern            = new RegExp('^(House|Residence|Home) [a-zA-Z \']*, *');

export function locationChanged(ev)
{
    ev.stopPropagation();
